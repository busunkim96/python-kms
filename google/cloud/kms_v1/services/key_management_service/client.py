...
class KeyManagementServiceClient(metaclass=KeyManagementServiceClientMeta):
    ...
    def get_key_ring(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method.wrap_method(
            self._transport.get_key_ring, default_timeout=None, client_info=_client_info
        )
    ...
    def encrypt(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method.wrap_method(
            self._transport.encrypt, default_timeout=None, client_info=_client_info
        )
    ...
    def decrypt(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method.wrap_method(
            self._transport.decrypt, default_timeout=None, client_info=_client_info
        )
